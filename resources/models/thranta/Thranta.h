...
void getThrantaParts(int startModelId, const std::string& folder, std::vector<ModelDescription>& models)
{
	{
		ModelDescription model{};
		model.id = startModelId + 0;
		model.name = "Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_metal02_d_0";
		model.filename = folder + "/Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_metal02_d_0.geom";
	...
	}
	{
		...
		model.filename = folder + "/Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_detail_d_0.geom";
		model.position = glm::vec3(0.f);
		model.scale = glm::vec3(1.f);
		model.rotation = glm::vec3(0.f); 
		models.push_back(model);
	}
	{
		...
		model.filename = folder + "/Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_metal01_d_0.geom";
		model.position = glm::vec3(0.f);
		model.scale = glm::vec3(1.f);
		model.rotation = glm::vec3(0.f); 
		models.push_back(model);
	}
	{
		...
		model.filename = folder + "/Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_engine_d_0.geom";
		model.position = glm::vec3(0.f);
		model.scale = glm::vec3(1.f);
		model.rotation = glm::vec3(0.f); 
		models.push_back(model);
	}
	{
		...
		model.filename = folder + "/Thranta-class_0002_veh_rep_destroyer_veh_rep_destroyer_trim_d_0.geom";
		model.position = glm::vec3(0.f);
		model.scale = glm::vec3(1.f);
		model.rotation = glm::vec3(0.f); 
		models.push_back(model);
...
void getThrantaMaterials(int startMaterialId, const std::string& folder, std::vector<MaterialDescription>& materials)
{
	{
		MaterialDescription material{};
		material.id = startMaterialId + 0;
		material.name = "veh_rep_destroyer_detail_d";
		material.filename = folder + "/veh_rep_destroyer_detail_d.mats";
	...
	}
	{
		...
		material.filename = folder + "/veh_rep_destroyer_engine_d.mats";
		material.albedo = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
		materials.push_back(material);
	}
	{
		...
		material.filename = folder + "/veh_rep_destroyer_metal01_d.mats";
		material.albedo = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
		materials.push_back(material);
	}
	{
		...
		material.filename = folder + "/veh_rep_destroyer_metal02_d.mats";
		material.albedo = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
		materials.push_back(material);
	}
	{
		...
		material.filename = folder + "/veh_rep_destroyer_trim_d.mats";
		material.albedo = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
		materials.push_back(material);
	}
}

GameObjectNode getThrantaParentNode(uint32_t& nodeId, uint32_t startModelId, uint32_t startMaterialId, const std::string& name, const glm::vec3 & position, const glm::vec3& scale, const glm::vec3& rotation)
{
	GameObjectNode node{};
	node.id = nodeId++;
	node.name = name;
