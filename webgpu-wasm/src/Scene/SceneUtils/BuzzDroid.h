...
std::vector<ModelDescription> getBuzzDroidParts(int startModelId)
{
    std::vector<ModelDescription> models;
    {
        ...
        model.filename = "Box038_meshId0_name_M_Buzz_UpperBody_0.geom";
    ...
    }
    {
        ...
        model.filename = "Box038.001_meshId1_name_M_Buzz_LowerBody_0.geom";
        model.position = glm::vec3(0.f);
        model.scale = glm::vec3(1.f);
        model.rotation = glm::vec3(0.f);
        models.push_back(model);
...
std::vector<MaterialDescription> getBuzzDroidMaterials(int startMaterialId)
{
    std::vector<MaterialDescription> materials;
    {
        ...
        material.filename = "M_Buzz_LowerBody.mats";
    ...
    }
    {
        ...
        material.filename = "M_Buzz_UpperBody.mats";
        material.albedo = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
        materials.push_back(material);
    }
    return materials;
...
GameObjectNode getBuzzDroidParentNode(uint32_t& nodeId, uint32_t startModelId, uint32_t startMaterialId, const std::string& name,
